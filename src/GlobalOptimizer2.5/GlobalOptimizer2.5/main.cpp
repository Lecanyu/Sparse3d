/************************************************************************/
// This optimizer is a implementation for Sparse3D paper's formulation. 
// Only keep one edge between two vertices.
/************************************************************************/
...
int main(int argc, char** argv)
{
	...
	if (argc != 9)
	{
		std::cout << "Usage:\nGlobalOptimizer2.5.exe init_pose_file[input_file] pointcloud_dir[input_dir] loop_file[input_file] loop_info_file[input_file] pose_file[output_file] loop_remain_file[output_file] info_remain_file[output_file] weight[double number, the more larger, the more edges will be save]\n";
		return -1;
	}
