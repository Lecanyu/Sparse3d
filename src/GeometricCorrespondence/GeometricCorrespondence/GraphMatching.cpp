...
GraphMatching::GraphMatching(pcl::PointCloud<pcl::PointXYZ>& keypoints1, pcl::PointCloud<pcl::PointXYZ>& keypoints2, const pcl::Correspondences& correspondence)
...
Eigen::Matrix4f GraphMatching::ComputeRigid(pcl::CorrespondencesConstPtr correspondence, const pcl::PointCloud<pcl::PointXYZ>& keypoints1, const pcl::PointCloud<pcl::PointXYZ>& keypoints2)
{
