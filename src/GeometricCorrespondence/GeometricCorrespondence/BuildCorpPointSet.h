...
public:
	...
	int ComputeCorrepondencePointSet(const Eigen::Matrix4f& transform, pcl::PointCloud<pcl::PointXYZRGB>::ConstPtr scene1, 
		pcl::PointCloud<pcl::PointXYZRGB>::ConstPtr scene2, double score_max_depth)
	{
